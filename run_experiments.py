...
def run_experiments(exp_names, pretrained):
	for exp_name in exp_names:
		...
		if exp_name == "resnet50_baseline":
			...
			updates = {'epochs': 100, 'learning_rate': 0.5, 'momentum': 0.93,
					   'aux_weight': [], 'aux_depth': [],
					   'grouping': [],
					   'num_coarse_classes': [], 'with_aux': False, 'optimize': False,
					   'aux_layouts': [],
					   'with_augmentation': True, 'batch_size': 8, 'network': 'resnet50',
			...
			updates = {'epochs': 1, 'learning_rate': 1e-3,  'momentum': 0.93,
			...
			updates = {'epochs': 1, 'learning_rate': 0.016, 'momentum': 0.9, 'weight_decay': 7e-4,
					   'aux_weight': [], 'aux_depth': [],
					   'grouping': [],
					   'num_coarse_classes': [], 'with_aux': False, 'optimize': False,
					   'aux_layouts': [],
			...
			updates = {'epochs': 100, 'learning_rate': 0.8, 'momentum': 0.9, 'weight_decay': 3e-4,
					   'aux_weight': [], 'aux_depth': [],
					   'grouping': [],
					   'num_coarse_classes': [], 'with_aux': False, 'optimize': False,
					   'aux_layouts': [],
					   'with_augmentation': True, 'batch_size': 8, 'network': 'DenseNet',
			...
			updates = {'epochs': 1, 'learning_rate': 0.01, 'momentum': 0.9, 'weight_decay': 3e-4,
